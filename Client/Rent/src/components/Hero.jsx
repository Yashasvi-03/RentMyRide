...
function Hero({ setFilters }) {
  ...
  return (
    <div
      className="min-h-screen bg-cover bg-center flex items-start md:items-center text-white relative pt-24 md:pt-0"
      style={{
        backgroundImage:
          "url('https://images.unsplash.com/photo-1493238792000-8113da705763')",
      }}
    >
      ...
      {/* CONTENT */}
      <div className="relative z-10 px-5 sm:px-8 md:px-20 max-w-4xl w-full pt-4 md:pt-0">
        {/* TITLE */}
        <motion.h1
          initial={{ opacity: 0, y: -60 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <motion.form
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.7 }}
          className="bg-white/40 text-white rounded-2xl shadow-2xl p-4 sm:p-6 w-full max-w-[500px]"
        >
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="Enter city"
                className="border rounded-lg p-2 text-black focus:ring-2 focus:ring-blue-300 outline-none"
              />
            </div>
          ...
          <div className="mt-5 text-center">
            <button
              type="submit"
              className="w-full sm:w-auto bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-3 rounded-lg hover:scale-105 transition font-semibold"
            >
              Search Cars
            </button>
          </div>
